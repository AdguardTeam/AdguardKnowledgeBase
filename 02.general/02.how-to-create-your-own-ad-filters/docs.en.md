...
> #### Compatibility with different versions of AdGuard
> Stealth Mode is currently available in AdGuard for Windows, macOS and Android. We plan to add it to all our products in future. For now, the products that do not support Stealth Mode will ignore the rules with this modifier.
