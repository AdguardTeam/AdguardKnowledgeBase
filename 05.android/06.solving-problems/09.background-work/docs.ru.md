...
> На некоторых устройствах OnePlus есть функции под названием *"Автозапуск"* и *"Глубокая Оптимизация"*. Работа этих функций не позволяет приложениям нормально работать в фоновом режиме. Пожалуйста, отключите их для вашего приложения.
