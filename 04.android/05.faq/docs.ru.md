...
Степень важности позволяет определить приоритет категорий (см. скриншот ниже).

![](importanceRU.png)

Будьте внимательны, начиная с версии Android 9 "Важность" переименована в "Действия"
