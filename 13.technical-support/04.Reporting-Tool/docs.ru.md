...
Вы можете поучаствовать в решении проблемы. Для этого вам необходимо понять, какой из модулей AdGuard приводит к некорректной работе страницы.
...
3. Если вы выявили, какой фильтр «ломает» страницу, сообщите об этом разработчикам при заполнении формы (см. выше). Также желательно сбросить настройки по умолчанию;
...
3. Если вам удалось выявить какая настройка «ломает» страницу, вам необходимо сообщить об этом разработчикам при заполнении формы (см. выше). В этом случае, желательно сбросить настройки в исходное положение;
...
Некоторые браузеры и антивирусы (такие, как Яндекс браузер, Kaspersky и т.д.) имеют встроенные блокировщики рекламы. Они могут влиять на функционирование сайтов и вызывать конфликты с AdGuard и приводить к некорректной работе сайтов.
