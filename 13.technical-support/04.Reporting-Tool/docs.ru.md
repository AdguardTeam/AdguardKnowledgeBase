...
1) Используя [Помощник AdGuard](https://uploads.adguard.com/Chinaskifgjv7.png) (По умолчанию находится в правом нижнем углу браузера);
...
2) [Сообщить на GitHub](agrd.io/report) (Все настройки необходимо заполнить вручную).
