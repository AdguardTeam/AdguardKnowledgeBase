...
Android на заводкой прошивке не конфликтует с фоновыми процессами, но если вы столкнулись с проблемами работы приложений, то необходимо включить режим «Всегда в VPN».
