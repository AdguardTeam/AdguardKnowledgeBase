...
Чтобы начать использовать пользовательские сертификаты в **стабильной** версии Firefox, убедитесь, что ваш браузер обновлён до версии 81.1.1 или выше. В качестве альтернативы можно установить актуальную nightly- или beta-версию. После этого активируйте скрытую опцию в настройках браузера:
