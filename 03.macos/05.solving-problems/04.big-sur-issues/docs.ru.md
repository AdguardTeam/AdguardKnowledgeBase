...
> После выхода обновления Big Sur 11.3 вернулись прежние проблемы с локальными прокси. Apple, скорее всего, уже работает над исправлением данного бага, и мы также рассматриваем возможности обойти это проблему. Пока не произойдёт одно из этих двух событий, AdGuard не сможет фильтровать локальный прокси.
