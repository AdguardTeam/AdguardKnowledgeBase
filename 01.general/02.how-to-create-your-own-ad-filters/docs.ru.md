...
> **Совместимость с различными версиями AdGuard.** Только AdGuard для Windows, Mac, Android имеют технические возможности для поддержки правил с модификатором `$extension`.
...
> **Предупреждение об устаревании.** Этот модификатор считаются устаревшими. Вместо него теперь используется модификатор `$redirect`. Правила с `$empty` конвертируются в `$redirect=nooptext`.
...
> **Совместимость с различными версиями AdGuard.** Правила с модификатором `$denyallow` не поддерживаются AdGuard Content Blocker.
...
> **Совместимость с различными версиями AdGuard.** Правила CSS-стилей не поддерживаются AdGuard Content Blocker.
...
> **Совместимость с различными версиями AdGuard.** Правила с расширенными CSS-селекторами не поддерживаются AdGuard Content Blocker.
...
> Дополнительная информация о скриптлетах, редиректах и их использовании доступна в [на GitHub](https://github.com/AdguardTeam/Scriptlets#adguard-scriptlets-and-redirect-resources).
