...
Вы вполне можете пользоваться AdGuard VPN для Windows, никогда не открывая **Расширенные настройки**. Однако они могут быть полезны, если вы найдёте время в них разобраться.
