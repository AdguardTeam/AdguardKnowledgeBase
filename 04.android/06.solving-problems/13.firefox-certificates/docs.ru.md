...
Различные версии браузера Firefox требуют разных подходов для осуществления [HTTPS-фильтрации](https://kb.adguard.com/ru/general/https-filtering). Если вы не можете установить сертификат непосредственно в сам браузер (в основном это случается в версии до 81.1.1), воспользуйтесь методом 1, описанным ниже. Если это не сработает, попробуйте метод 2 — он займёт чуть больше времени, но сработает для любой версии Firefox.
