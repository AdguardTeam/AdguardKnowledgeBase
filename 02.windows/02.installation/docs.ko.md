...
먼저 개발자들이 만든 제거 도구를 다운로드하십시오. [이 링크](https://cdn.adguard.com/distr/windows/Uninstall_Utility.zip)를 클릭하면 제거 도구를 다운로드할 수 있습니다. PC의 폴더에 압축을 풀고 Adguard_Uninstall_Utility.exe 파일을 실행합니다. 그런 다음 아래 지침을 따르십시오.
