...
- Активация путём введения **логина** и **лароля** от **учётной записи AdGuard**.
...
<img src="https://cdn.adguard.com/public/Adguard/kb/newscreenshots/En/General/reneworupgrade.png" width="350" />

Зайдя в [личный кабинет](https://adguard.com/ru/login.html) AdGuard, вы увидите список ваших лицензионных ключей и их текущий статус.

Если лицензионный ключ активирован на одном или более устройствах, вы увидите их список под лицензионным ключом. Лицензионный ключ может быть активирован на ограниченном количестве устройств. Если лицензионный ключ уже используется на максимально возможном количестве устройств, перед тем как снова использовать его, вы должны отвязать его от одного из них.  
