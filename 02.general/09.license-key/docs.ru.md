...
Лицензионный ключ - это уникальный набор символов, с помощью которого может быть активирован AdGuard. Лицензионный ключ необходим для полноценной работы AdGuard после истечения пробного периода использования программы. Существует три типа лицензий:

1. **Персональная** - данный лицензионный ключ позволяет вам активировать AdGuard на любых **трёх** устройствах.

2. **Семейная** - также является универсальным типом лицензии, разница лишь в кол-ве устройств устройств. Приобретая данный ключ, вы становитесь обладателем **девяти** заветных лицензий для ваших девайсов.

3. **Бета-тест** — специальный тип лицензии для бета-тестировщиков AdGuard. Программа, активированная таким типом лицензии, автоматически обновляется до последней доступной бета-версии. 

**ВНИМАНИЕ**: Все виды лицензии является универсальным. Вы можете активировать любое из представленных устройств:
- **Windows**, **Mac**, **Android** или **iOS**, в любой комбинации.
