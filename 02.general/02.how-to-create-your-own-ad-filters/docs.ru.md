...
> **Важно:** избегайте специальных символов вроде `,`, `/` и `$` в регулярных выражениях. Для этого используйте экранирование при помощи символа `\`. Например, "запятая" будет в этом случае выглядеть так: `\,`.
