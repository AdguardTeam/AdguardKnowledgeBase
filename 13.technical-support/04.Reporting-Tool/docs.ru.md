...
* Откройте настройки браузерного расширения кликнув на соответствующий значок;
...
2. Если это решило проблему, включите модуль и поочерёдно отключайте фильтры с проверкой результата. Это необходимо для того, чтобы определить какие фильтры «ломают» страницу;
3. Если вы выяснили, какой фильтр приводит к некорректной блокировке, сообщите об этом разработчикам при заполнении формы (см. выше). Также желательно сбросить настройки в исходное состояние;
...
3. Если вам удалось выявить какая настройка «ломает» страницу, вам необходимо сообщить об этом разработчикам при заполнении формы (см. выше). В этом случае, желательно сбросить настройки в исходное состояние;
...
2. Если это решило проблему, включите модуль и поочерёдно отключите настройки **Расширений** с проверкой результата. Это необходимо для того, чтобы определить какая настройка мешает корректной работе страницы;
3. Если вам удалось выявить какая настройка «ломает» страницу, вам необходимо сообщить об этом разработчикам при заполнении формы (см. выше). В этом случае, желательно сбросить настройки в исходное состояние.
