...
На устройствах Asus предустановлено приложение оптимизации под названием Power Master с некоторыми изменениями, сделанными по умолчанию, например. блокирование приложений от запуска и уничтожение фоновых задач при выключении экрана.

Однако, если вы знаете, как, вы можете легко отключить их. «User_solution:« Злое приложение на Asus называется Power Master. Смотрите скриншоты ниже. Чтобы убедиться, что фоновая обработка приложений работает, убедитесь, что следующее настроено правильно.
