...
- Введя **Логин** и **Пароль** от **учетной записи AdGuard**.
...
2. Откройте опции, щелкнув мышью на **иконке шестерёнки**, и в выпадающем меню выберите "Лицензия", далее кликните "Активировать".  
