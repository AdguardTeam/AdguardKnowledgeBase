...
2. **Семейная** - данный лицензионный ключ позволяет вам активировать AdGuard на **любых девяти** устройствах.

**ВНИМАНИЕ**: Все виды лицензии является универсальным. Вы можете активировать лицензию на любой из предоставленных ОС:
- **Windows**, **Mac**, **Android** или **iOS**.
