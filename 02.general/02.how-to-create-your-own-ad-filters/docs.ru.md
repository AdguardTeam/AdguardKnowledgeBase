...
> #### Совместимость с разными версиями AdGuard
> Модуль "Антитрекинг" на данный момент доступен только в приложениях: AdGuard для Windows, AdGuard для Mac и AdGuard для Android. В будущем мы планируем добавить его во все продукты AdGuard. В продуктах без поддержки модуля "Антитрекинг" правила с этим модификатором игнорируются.
