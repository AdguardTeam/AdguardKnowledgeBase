...
> **Совместимость с различными версиями AdGuard.** Заметьте, что CSS-правила поддерживаются AdGuard для iOS, начиная с iOS 15.
...
> **Совместимость с различными версиями AdGuard.** Javascript-правила поддерживаются AdGuard для iOS, начиная с iOS 15.
