...
> Cинтаксис `$removeparam` для регулярных выражений будет доступен начиная с версии 1.8 [CoreLibs](https://adguard.com/ru/blog/introducing-corelibs.html) и версии 3.6.7 браузерного расширения AdGuard, а пока используйте упрощенный вариант: `$removeparam=param`.
