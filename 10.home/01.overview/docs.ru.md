...
​
AdGuard Home работает как DNS-сервер, который перенаправляет домены трекеров в "чёрную дыру", тем самым предотвращая подключение ваших устройств к этим серверам. Он основан на программном обеспечении, которое мы используем для наших публичных серверов [AdGuard DNS](https://adguard-dns.io/welcome.html) – у них много общего кода.
​
​
<a id="features"></a>
​
