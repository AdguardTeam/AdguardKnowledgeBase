...
Вы можете помочь нам обнаружить проблему заполнив заявку, используя представленные ниже инструкции в зависимости от вашей ОС.
...
1) [Сообщить на GitHub](agrd.io/report) (Все настройки необходимо заполнить вручную);
...
Вы можете поучаствовать в решении проблемы. Для этого вам необходимо понять, какой из модулей AdGuard не дает странице корректно работать.
...
Некоторые браузеры и антивирусы (такие, как Яндекс браузер, Kaspersky и т.д.) имеют встроенные блокировщики рекламы. Они могут влиять на функционирование сайтов и вызывать проблемы в их работе.
Если вы пользуетесь подобными программами, убедитесь, что проблема вызвана именно AdGuard: отключите фильтрацию и попробуйте повторить проблему. Если она сохранится, значит проблема обусловлена другим приложением или браузером.