...
Если при использовании AdGuard VPN для iOS вы столкнулись с ошибкой, вы можете сообщить о ней, отправив нам логи — журнал работы приложения.

<a name="default"></a>

## Сбор и отправка стандартных логов

По умолчанию в AdGuard VPN для macOS используется стандартный уровень логирования, то есть базовый сбор данных о работе приложения. Для того, чтобы отправить такие логи, выполните следующие шаги:

1. Откройте приложение AdGuard VPN для macOS и, если возможно, воспроизведите действия, которые привели к ошибке. Запомните точное время, когда эта ошибка произошла.
...
1. Откройте приложение AdGuard VPN для macOS и выберите **Настройки** (в меню сверху) → **Основные настройки** → **Расширенные настройки**.
