...
>**Ограничения**
>Пожалуйста, заметьте, что этот тип правил может быть испольован **только в доверенных фильтрах**. Эта категория включает в себя ваш собственный **Пользовательский фильтр**, а также все фильтры, созданные командой разработчиков AdGuard.
