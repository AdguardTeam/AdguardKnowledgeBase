...
* [AdGuard не может запустить VPN сервер](#vpnvpn)
...
На некотоых моделях телефонов, планшетов или телевизоров под операционной системной Android могут возникать проблемы, связанные с использованием на устройстве **профиля с ограниченным доступом**. При использовании этого режима, AdGuard как и другие приложения использующие VPN, получают ограничение на выборочную фильтрацию VPN трафика. В результате AdGuard начинает фильтровать самого себя. Это может привести к его некорректному функционированию и вызвать проблемы в работе других приложений. Ниже описаны рекомендации, которое можно при возникновении проблемы с созданием **локального VPN** на устройстве.
...
3. Разрешить A*dGuard* взаимодействие между пользователями для выборочной фильтрации трафика через [**adb**](https://developer.android.com/studio/command-line/adb) (*Android Debug Bridge*):

- Установить и настроить [**adb**](https://www.xda-developers.com/install-adb-windows-macos-linux/);
