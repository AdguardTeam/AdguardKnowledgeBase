...
2. Откройте опции, щелкнув мышью на **пиктограмме шестерёнки**, и в выпадающем меню выберите "Лицензия", далее кликните "Активировать".  
...
3) После того как вы нажмете **Активировать Премиум**, вам будут представлены несколько вариантов активации:
- Активация путём введения **Логина** и **Пароля** от **учетной записи AdGuard**.
...
1. Откройте меню программу и нажмите на **пиктограмму шестерёнки** в правом верхнем углу экрана.
...
3. Вы можете приобрести лицензию непосредственно в **AppStore**, либо активировать **Premium** при помощи **авторизации** в **личный кабинет** AdGuard.
