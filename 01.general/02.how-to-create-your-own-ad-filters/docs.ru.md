...
4. тег может относиться к одному сегменту, т.е. к первой URL-строке, следующей после данного тега,
   ко всем последующим сегментами (до тех пор пока не встретится тег с тем же именем), или ко всему плейлисту.
