...
![](notificationsRU.png?resize=600) 
...
Все категории уведомлений активированы по умолчанию. Вы можете управлять настройками каждой из них (см. предыдущий скриншот — справа) — изменять статус важности, выбирать звук уведомлений из поддерживаемых устройством, включать/отключать вибрацию и т.д.  

Cтатус важности позволяет определить приоритетность категорий (см. скриншот ниже).

![](importanceRU.png?resize=600)

Вы можете выбрать из 4-х представленных статусов (уровней) важности:

+ **Крайняя важность** (уведомления сопровождаются звуковым сигналом и всплывают на экране устройства); 
+ **Высокий** (уведомления сопровождаются звуковым сигналом); 
+ **Средний** (уведомления не сопровождаются звуковым сигналом);
+ **Низкий** (уведомления не сопровождаются звуковым сигналом и визуальными эффектами). 

Обратите внимание: вы не можете включать/отключать вибрацию для тех категорий уведомлений, статус важности которых определен как Средний или Низкий.
...
Вы также можете отключить все уведомления AdGuard (что мы не рекомендуем делать), выбрав опцию **“Блокировать все”**.
