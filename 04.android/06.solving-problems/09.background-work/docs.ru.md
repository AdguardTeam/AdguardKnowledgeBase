...
Выберите встроенное приложение "Безопасность". Затем нажмите на иконку с изображением шестеренки в правом верхнем углу, чтобы 
открыть "Специальные настройки".
...
<img src="https://cdn.adguard.com/public/Adguard/kb/android/miui_ru4.png" width="300">
